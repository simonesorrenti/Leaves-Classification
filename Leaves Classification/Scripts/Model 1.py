...
dataset_gen = ImageDataGenerator(rotation_range=180,
...
train_gen = dataset_gen.flow_from_directory(directory='../input/colorpv/color',
                                            target_size=(256, 256),
                                            color_mode='rgb',
...
valid_gen = dataset_gen.flow_from_directory(directory='../input/colorpv/color',
                                            target_size=(256, 256),
                                            color_mode='rgb',
                                            classes=None,  # can be set to labels
                                            class_mode='categorical',
...
model.save('InceptionV3_Fine_Tuning_F1_weights.h5')
